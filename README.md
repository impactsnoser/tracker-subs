...
1. Открой вкладку **[Actions в репозитории](https://github.com/impactsnoser/subscriptions-tracker/actions/workflows/build-ipa.yml)**.
...
Если хочешь собрать IPA сам — можно запустить workflow вручную: **[Run workflow →](https://github.com/impactsnoser/subscriptions-tracker/actions/workflows/build-ipa.yml)** (кнопка *Run workflow* справа сверху).
